...
export default function GoldCoinIcon({ width = 24, height = 24, style }) {
    ...
    const goldMainId = `goldMain_${uniqueId}`;
    const goldEdgeId = `goldEdge_${uniqueId}`;
    const goldInnerId = `goldInner_${uniqueId}`;
    const coinShineId = `coinShine_${uniqueId}`;

    return (
        <Svg width={width} height={height} viewBox="0 0 48 48" style={style}>
            <Defs>
                {/* Main gold gradient */}
                <RadialGradient id={goldMainId} cx="40%" cy="35%" r="65%">
                ...
                <LinearGradient id={goldEdgeId} x1="0%" y1="0%" x2="0%" y2="100%">
                ...
                <RadialGradient id={goldInnerId} cx="45%" cy="40%" r="60%">
                ...
                {/* Shine effect */}
                <RadialGradient id={coinShineId} cx="35%" cy="30%" r="45%">
            ...
            {/* Main coin body */}
            <Circle cx="24" cy="24" r="16" fill={`url(#${goldMainId})`} />

            {/* Metallic rim */}
            <Circle cx="24" cy="24" r="16" fill="none" stroke={`url(#${goldEdgeId})`} strokeWidth="1.2" />
            ...
            <Circle cx="24" cy="24" r="11" fill={`url(#${goldInnerId})`} />
            ...
            {/* Top shine effect */}
            <Circle cx="24" cy="24" r="16" fill={`url(#${coinShineId})`} />
